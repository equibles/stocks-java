...
public class FundamentalsApiTest {
     ...
     */
    @Test
    public void dividendsTest() throws Exception {
        String fullTicker = null;
        Integer page = null;
        Integer pageSize = null;
        DividendsResponse response = api.dividends(fullTicker, page, pageSize);
     ...
     */
    @Test
    public void financialReportsTest() throws Exception {
        String fullTicker = null;
        Integer year = null;
        FiscalPeriod fiscalPeriod = null;
        Integer page = null;
        Integer pageSize = null;
        FundamentalsResponse response = api.financialReports(fullTicker, year, fiscalPeriod, page, pageSize);
